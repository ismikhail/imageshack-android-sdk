...
public class Const {
	...
	public static final String TIMEOUT_ERROR = "Connection error";
	...
	public static final String PROTOCOL =  SSL ? "https://" : "http://";
	
	// API common
	public static final String API = DEBUG_MODE ? "img775.imageshack.us/rest_api/v2/" : "imageshack.com/rest_api/v2/";
